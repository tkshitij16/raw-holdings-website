...
test('hero leads with RAW Holdings and includes the Chicago map layer',()=>{const page=read('app/page.tsx');assert.match(page,/<h1>RAW HOLDINGS<\/h1>/);assert.match(page,/hero-map/);assert.match(read('src/content/media.ts'),/chicago-spring-skyline\.png/)});
